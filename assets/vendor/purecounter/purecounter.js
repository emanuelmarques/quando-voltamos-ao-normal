                ...
                (n = [
                    {
                        ...
                        value: function () {
                            ...
                            if (this.intersectionListenerSupported()) for (var n = new IntersectionObserver(this.animateElements.bind(this), { root: null, rootMargin: "20px", threshold: 0.5 }), r = 0; r < t.length; r++) n.observe(t[r]);
                            else
                        ...
                        value: function (e, t) {
                            ...
                            e.forEach(function (e) {
                                ...
                                return r.duration <= 0
                                    ...
                                    : (!t && !n.elementIsInView(e)) || (t && e.intersectionRatio < 0.5)
                    ...
                    },
                    {
                        ...
                        value: function (e, t) {
                            ...
                            var o = setInterval(function () {
                                ...
                                (e.innerHTML = (n.formatNumber(s, t)).toLocaleString('pt-PT')),
                                    (((i = s) >= t.end && "inc" == a) || (i <= t.end && "dec" == a)) && (clearInterval(o), i != t.end && (e.innerHTML = t.decimals <= 0 ? parseInt(t.end).toLocaleString('pt-PT') : parseFloat(t.end).toFixed(t.decimals)));
                            }, t.delay);
                        },
                    },
                    {
                        ...
                        value: function (e) {
                            for (
                                var t = [].filter.call(e.attributes, function (e) {
                                    ...
                                    n = { start: 0, end: 9001, duration: 2e3, delay: 10, once: !0, decimals: 0, legacy: !0 },
                                    r = 0;
                                r < t.length;
                                r++
                            ) {
                    ...
                    },
                    {
                        key: "formatNumber",
                        value: function (e, t) {
                            return t.decimals <= 0 ? parseInt(e) : e.toLocaleString('pt-PT', { minimumFractionDigits: t.decimals, maximumFractionDigits: t.decimals });
                        },
                    },
                    {
                        key: "castDataType",
